...
ProcessResume
  (
   ResumeFile => "/var/lib/myfrdcsa/codebases/internal/job-search/data/profiles/Amanda-Wilcox/Amanda-Wilcox-resume.txt",
   ResumeURL => "http://frdcsa.org/",
   OutputLocation => "/var/www/job-search/results/anon.html",
  );
